...
namespace sct.svc.mrp.imp
{
    ...
    public  class ProductBillService : ProductBillBaseService,IProductBillService
    { 

         public PageResult<ProductBillInfo>  ListByCondition(NameValueCollection searchCondtionCollection, NameValueCollection sortCollection, int pageNumber, int pageSize)
         {
            PageResult<ProductBillInfo> result = new PageResult<ProductBillInfo>();

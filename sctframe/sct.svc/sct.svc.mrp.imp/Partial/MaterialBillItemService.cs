...
namespace sct.svc.mrp.imp
{
    ...
    public  class MaterialBillItemService : MaterialBillItemBaseService,IMaterialBillItemService
    { 

         public PageResult<MaterialBillItemInfo>  ListByCondition(NameValueCollection searchCondtionCollection, NameValueCollection sortCollection, int pageNumber, int pageSize)
         {
            PageResult<MaterialBillItemInfo> result = new PageResult<MaterialBillItemInfo>();

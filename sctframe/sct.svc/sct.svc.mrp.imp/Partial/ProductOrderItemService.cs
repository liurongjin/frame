...
namespace sct.svc.mrp.imp
{
    ...
    public  class ProductOrderItemService : ProductOrderItemBaseService,IProductOrderItemService
    { 

         public PageResult<ProductOrderItemInfo>  ListByCondition(NameValueCollection searchCondtionCollection, NameValueCollection sortCollection, int pageNumber, int pageSize)
         {
            PageResult<ProductOrderItemInfo> result = new PageResult<ProductOrderItemInfo>();

...
namespace sct.svc.mrp.imp
{
    ...
    public  class MaterialPurchaseItemService : MaterialPurchaseItemBaseService,IMaterialPurchaseItemService
    { 

         public PageResult<MaterialPurchaseItemInfo>  ListByCondition(NameValueCollection searchCondtionCollection, NameValueCollection sortCollection, int pageNumber, int pageSize)
         {
            PageResult<MaterialPurchaseItemInfo> result = new PageResult<MaterialPurchaseItemInfo>();

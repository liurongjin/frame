...
namespace sct.svc.mrp.imp
{
    ...
    public  class ProductBillItemService : ProductBillItemBaseService,IProductBillItemService
    { 

         public PageResult<ProductBillItemInfo>  ListByCondition(NameValueCollection searchCondtionCollection, NameValueCollection sortCollection, int pageNumber, int pageSize)
         {
            PageResult<ProductBillItemInfo> result = new PageResult<ProductBillItemInfo>();

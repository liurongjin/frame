...
namespace sct.svc.mrp.imp
{
    ...
    public  class MaterialPurchasePlanService : MaterialPurchasePlanBaseService,IMaterialPurchasePlanService
    { 

         public PageResult<MaterialPurchasePlanInfo>  ListByCondition(NameValueCollection searchCondtionCollection, NameValueCollection sortCollection, int pageNumber, int pageSize)
         {
            PageResult<MaterialPurchasePlanInfo> result = new PageResult<MaterialPurchasePlanInfo>();

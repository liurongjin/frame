...
namespace sct.svc.mrp.imp
{
    ...
    public  class MaterialWareStockService : MaterialWareStockBaseService,IMaterialWareStockService
    { 

         public PageResult<MaterialWareStockInfo>  ListByCondition(NameValueCollection searchCondtionCollection, NameValueCollection sortCollection, int pageNumber, int pageSize)
         {
            PageResult<MaterialWareStockInfo> result = new PageResult<MaterialWareStockInfo>();

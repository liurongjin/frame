...
[DataContract]
  public partial class ProductInfo
  {
    ...
    [DataMember]
    internal int  _ProductCatalogIdIsDirty = 0; 

    [DataMember]
    internal string  _ProductCatalogId; 
    ...
    public string  ProductCatalogId
    {
      ...
      set{
         ...
         _ProductCatalogIdIsDirty = 1;
      }
    }

    [DataMember]
    internal int  _ProductCodeIsDirty = 0; 

    [DataMember]
    internal string  _ProductCode; 

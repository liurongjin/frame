...
[DataContract]
  public partial class GatherBillInfo
  {
    [DataMember]
    ...
    [DataMember]
    internal int  _GatherMethodIsDirty = 0; 

    [DataMember]
    internal int  _GatherMethod; 

    [DataMember]
    public int  GatherMethod
    {
      get{
         return _GatherMethod;
      }
      set{
         _GatherMethod = value;
         _GatherMethodIsDirty = 1;
      }
    }

    [DataMember]
    internal int  _GatherAccountIsDirty = 0; 

    [DataMember]
    internal string  _GatherAccount; 

    [DataMember]
    [StringLength(200)]
    public string  GatherAccount
    {
      get{
         return _GatherAccount;
      }
      set{
         _GatherAccount = value;
         _GatherAccountIsDirty = 1;
      }
    }

    [DataMember]
    internal int  _GatherPriceIsDirty = 0; 

    [DataMember]
    internal decimal  _GatherPrice; 

    [DataMember]
    public decimal  GatherPrice
    {
      get{
         return _GatherPrice;
      }
      set{
         _GatherPrice = value;
         _GatherPriceIsDirty = 1;
      }
    }

    [DataMember]
    internal int  _GatherDateIsDirty = 0; 

    [DataMember]
    internal DateTime  _GatherDate; 

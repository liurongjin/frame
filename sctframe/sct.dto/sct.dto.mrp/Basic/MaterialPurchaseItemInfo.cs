...
[DataContract]
  public partial class MaterialPurchaseItemInfo
  {
    [DataMember]
    ...
    [DataMember]
    internal int  _MaterialPurchaseIdIsDirty = 0; 

    [DataMember]
    internal string  _MaterialPurchaseId; 

    [DataMember]
    [StringLength(36)]
    public string  MaterialPurchaseId
    {
      get{
         return _MaterialPurchaseId;
      }
      set{
         _MaterialPurchaseId = value;
         _MaterialPurchaseIdIsDirty = 1;
      }
    }

...
[DataContract]
  public partial class ProductBillItemInfo
  {
    [DataMember]
    ...
    [DataMember]
    internal int  _ProductBillIdIsDirty = 0; 

    [DataMember]
    internal string  _ProductBillId; 

    [DataMember]
    [StringLength(36)]
    public string  ProductBillId
    {
      get{
         return _ProductBillId;
      }
      set{
         _ProductBillId = value;
         _ProductBillIdIsDirty = 1;
      }
    }

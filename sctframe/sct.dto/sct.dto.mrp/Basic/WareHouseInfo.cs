...
[DataContract]
  public partial class WareHouseInfo
  {
    ...
    [DataMember]
    internal int  _WareHouseCodeIsDirty = 0; 

    [DataMember]
    internal string  _WareHouseCode; 
    ...
    public string  WareHouseCode
    {
      ...
      set{
         ...
         _WareHouseCodeIsDirty = 1;
      }
    }

    [DataMember]
    internal int  _WareHouseNameIsDirty = 0; 

    [DataMember]
    internal string  _WareHouseName; 
    ...
    [DataMember]
    internal int  _AddressIsDirty = 0; 

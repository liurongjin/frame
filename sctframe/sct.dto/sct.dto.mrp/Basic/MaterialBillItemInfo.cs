...
[DataContract]
  public partial class MaterialBillItemInfo
  {
    [DataMember]
    ...
    [DataMember]
    internal int  _MaterialBillIdIsDirty = 0; 

    [DataMember]
    internal string  _MaterialBillId; 
    ...
    {
      get{
         return _MaterialBillId;
      }
      set{
         _MaterialBillId = value;
         _MaterialBillIdIsDirty = 1;
      }
    }

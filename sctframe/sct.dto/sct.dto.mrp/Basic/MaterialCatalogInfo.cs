...
[DataContract]
  public partial class MaterialCatalogInfo
  {
    ...
    [DataMember]
    internal int  _MaterialCatalogCodeIsDirty = 0; 

    [DataMember]
    internal string  _MaterialCatalogCode; 

    [DataMember]
    [StringLength(200)]
    public string  MaterialCatalogCode
    {
      get{
         return _MaterialCatalogCode;
      }
      set{
         _MaterialCatalogCode = value;
         _MaterialCatalogCodeIsDirty = 1;
      }
    }

    [DataMember]
    internal int  _MaterialCatalogNameIsDirty = 0; 

    [DataMember]
    internal string  _MaterialCatalogName; 

    [DataMember]
    [StringLength(200)]
    public string  MaterialCatalogName
    {
      get{
         return _MaterialCatalogName;
      }
      set{
         _MaterialCatalogName = value;
         _MaterialCatalogNameIsDirty = 1;
      }
    }

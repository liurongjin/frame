...
[DataContract]
  public partial class ProductCatalogInfo
  {
    ...
    [DataMember]
    internal int  _ProductCatalogCodeIsDirty = 0; 

    [DataMember]
    internal string  _ProductCatalogCode; 

    [DataMember]
    [StringLength(200)]
    public string  ProductCatalogCode
    {
      get{
         return _ProductCatalogCode;
      }
      set{
         _ProductCatalogCode = value;
         _ProductCatalogCodeIsDirty = 1;
      }
    }

    [DataMember]
    internal int  _ProductCatalogNameIsDirty = 0; 

    [DataMember]
    internal string  _ProductCatalogName; 
    ...
    {
      get{
         return _ProductCatalogName;
      }
      set{
         _ProductCatalogName = value;
         _ProductCatalogNameIsDirty = 1;
      }
    }

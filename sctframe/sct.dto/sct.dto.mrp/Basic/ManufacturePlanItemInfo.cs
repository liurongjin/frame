...
[DataContract]
  public partial class ManufacturePlanItemInfo
  {
    [DataMember]
    ...
    [DataMember]
    internal int  _ManufacturePlanIdIsDirty = 0; 

    [DataMember]
    internal string  _ManufacturePlanId; 

    [DataMember]
    [StringLength(36)]
    public string  ManufacturePlanId
    {
      get{
         return _ManufacturePlanId;
      }
      set{
         _ManufacturePlanId = value;
         _ManufacturePlanIdIsDirty = 1;
      }
    }
